...
## まとめ一式を1ファイルで（貼り付け用・おすすめ）

`obsidian/高齢者支援事業-まとめ一式.md` に全部入っています。

| 方法 | 手順 |
|------|------|
| **貼り付け** | ファイルを開く → 全文コピー → Obsidianで新規ノート → 貼り付け |
| **コピー** | `.md` ファイルを iCloud Vault 内に保存 |

含まれる内容：事業設計15項目・面談チートシート・初月成果物5点。目次から `[[#パート1...]]` でジャンプできます。

---

`obsidian/高齢者支援事業/` フォルダには、個別ノート版もあります。
